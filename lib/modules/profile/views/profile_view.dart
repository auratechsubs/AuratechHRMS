...
import '../../leave/views/leave_list_page.dart';
        ...
        body: ListView(
          ...
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      ...
                      subtitle: Text(
                        'PAN, Aadhaar, Offer Letter आदि PDF/IMG अपलोड करें',
                      ),
                      trailing: InkWell(
                        onTap: () {},
                        child: Icon(
                    ...
                    if (controller.employeeDocs.isNotEmpty)
                      Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: controller.employeeDocs
                              .map(
                                (doc) => ListTile(
                                  leading: Icon(
                  ...
                  children: [
                    ...
                    if (controller.salarySlips.isNotEmpty)
                      Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: controller.salarySlips
                              .map(
                                (slip) => ListTile(
                                  leading: Icon(
                                  ...
                                  trailing: IconButton(
                                    ...
                                    tooltip: 'Download',
                                    onPressed: () =>
                                        controller.downloadSalarySlipFile(slip),
                                  ),
                                ),
                              )
                              .toList(),
            ...
            ListTile(
              ...
              subtitle: Text(
                'Pending punches: ${attendanceController.pendingQueueLength}',
              ),
